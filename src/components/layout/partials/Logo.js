...
const Logo = ({
  ...
  return (
    ...
    >
      <h1 className="m-0">
        <Link to="/">
          <svg version="1.1" width="80px" height="80px" viewBox="0 0 50 50">
            <path className="path" fillOpacity="0" stroke="#FFA173" strokeOpacity="1" stroke-width="1" d="M43.443,21.147l-3.5-7.286c-0.108-0.226-0.336-0.369-0.586-0.369H10.714c-0.248,0-0.475,0.142-0.584,0.364l-3.571,7.286
